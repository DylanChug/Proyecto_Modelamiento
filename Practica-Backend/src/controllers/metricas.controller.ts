...
import { RequestConUsuario } from '../middleware/auth.middleware.js'; // Ajusta la ruta a tu tipo de Request personalizado
import { prisma } from '../config/db.js';

export const obtenerProgresoMensual = async (req: RequestConUsuario, res: Response) => {
    try {
        ...
        let periodoBuscado = periodo as string;
