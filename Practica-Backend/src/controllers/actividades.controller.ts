...
export const obtenerActividades = async (req: RequestConUsuario, res: Response) => {
  try {
...
export const crearActividad = async (req: RequestConUsuario, res: Response) => {
  try {
    ...
    const {
      ...
      titulo,
      descripcion,
      tipo_actividad, // Se puede mapear a 'categoria' si es lo que usas en el modelo
...
export const actualizarActividad = async (req: RequestConUsuario, res: Response) => {
  try {
    const emailOIdUsuario = req.usuario?.id_usuario || req.usuario?.id || req.usuario?.email;
...
export const eliminarActividad = async (req: RequestConUsuario, res: Response) => {
  try {
    const emailOIdUsuario = req.usuario?.id_usuario || req.usuario?.id || req.usuario?.email;
