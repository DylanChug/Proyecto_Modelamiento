...
export const consultarIAOptimizar = async (contexto) => {
...
export const consultarIAReoptimizar = async (contexto) => {
    const promptSistema = `
    ...
    const contenido = respuesta.text;
    if (!contenido)
        throw new Error("La IA devolvió una respuesta de re-optimización vacía.");
    return JSON.parse(contenido);
};
