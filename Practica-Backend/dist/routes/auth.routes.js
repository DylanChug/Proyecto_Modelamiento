...
import { autenticarUsuario, enviarCodigoRecuperacion, loginLocal, registrarUsuarioLocal, verificarCodigoYCambiarPassword } from '../controllers/auth.controller.js'; // 👈 Asegúrate del .js
const router = Router();
